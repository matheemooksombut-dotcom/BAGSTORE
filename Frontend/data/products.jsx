    ...
    const products =  [
        {   id: 1,
            ...
            variants:[
                ...
                {
                    color:"pink",
                    image:"/item1-pink.jpg"
                }

            ], 
            hoverImage: "/showbag1.png",
            name:"Product1", 
         ...
         {   id: 2,
            ...
            variants:[
                {
                            color:"rgb(233, 203, 246)",
                            image:"/bag2.png"
                        },
                        {
                            color:"rgb(183, 248, 210)",
                            image:"/item2-mint.jpg"
                 }
            ],
            hoverImage: "/showbag2.png",

             colors:["rgb(233, 203, 246)","rgb(183, 248, 210)"] ,
            name:"Product2",
